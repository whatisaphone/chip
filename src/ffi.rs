...
impl<_RanIt> Default for std_reverse_iterator<_RanIt> {
    fn default() -> Self {
        unsafe { ::std::mem::zeroed() }
    }
}
...
pub type std__Vector_const_iterator__Unchecked_type = std__Vector_const_iterator_pointer;
...
pub type std__Vector_iterator__Unchecked_type = std__Vector_iterator_pointer;
...
extern "C" {
    #[link_name = "\u{1}?bounding_box@Car@@QEAA?AUobb@@XZ"]
    pub fn Car_bounding_box(this: *mut Car) -> obb;
}
extern "C" {
...
impl Car {
    ...
    #[inline]
    pub unsafe fn bounding_box(&mut self) -> obb {
        Car_bounding_box(self)
    }
    #[inline]
